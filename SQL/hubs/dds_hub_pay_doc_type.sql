...
records_to_insert as (
		...
		left join {{ params.prefix }}_dds_hub_pay_doc_type as d
		on a.PAY_DOC_TYPE_PK = d.PAY_DOC_TYPE_PK
		where d.PAY_DOC_TYPE_PK is NULL
)
insert into {{ params.prefix }}_dds_hub_pay_doc_type (PAY_DOC_TYPE_PK, PAY_DOC_TYPE_KEY, LOAD_DATE, RECORD_SOURCE)
(
	select PAY_DOC_TYPE_PK, PAY_DOC_TYPE_KEY, LOAD_DATE, RECORD_SOURCE
